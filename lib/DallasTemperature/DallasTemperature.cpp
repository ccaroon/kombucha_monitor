...
void DallasTemperature::readScratchPad(const uint8_t *deviceAddress,
                                       uint8_t *scratchPad) {
    // send the command
    _wire->reset();
...
bool DallasTemperature::alarmSearch(uint8_t *newAddr) {
    ...
    for (i = 0; i < 64; i++) {
        ...
        // I don't think this should happen, this means nothing responded, but
        // maybe if
